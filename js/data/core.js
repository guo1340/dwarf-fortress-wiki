...
(function () {
  ...
  "sourceRegistry": {
    "bay12": {
      ...
      "note": "Official Dwarf Fortress source and developer updates."
    },
    "steam": {
      "label": "Dwarf Fortress Steam Page",
      "url": "https://store.steampowered.com/app/975370/Dwarf_Fortress/",
      "note": "Official Steam release and feature overview."
    },
    "communityWiki": {
      "label": "Dwarf Fortress Wiki",
      "url": "https://dwarffortresswiki.org/",
      "note": "Community mechanics reference for systems, items and creatures."
    },
    "dfhack": {
  ...
  "categories": [
    {
      ...
      "icon": "mug",
      "summary": "Steam setup, first fortress tutorials, starter layouts and beginner mistakes."
    },
    {
      "id": "fortress",
      "title": "Fortress",
      "icon": "fortress",
      "summary": "Bedrooms, taverns, temples, libraries, hospitals, justice, nobility and fortress design."
    },
    {
      "id": "industry",
      "title": "Industry",
      "icon": "anvil",
      "summary": "Farming, brewing, cooking, mining, smithing, soap, glass, cloth, leather and trade."
    },
    {
      "id": "military",
      "title": "Military",
      "icon": "shield",
      "summary": "Squads, weapons, armor, defenses, sieges, war animals and megaproject weapons."
    },
    {
      "id": "creatures",
      "title": "Creatures",
      "icon": "dragon",
      "summary": "Civilized races, underground creatures, forgotten beasts, titans, necromancers and werebeasts."
    },
    {
      "id": "world",
      "title": "World",
      "icon": "mountain",
      "summary": "World generation, biomes, caverns, magma, aquifers, weather and climate."
    },
    {
      "id": "adventure-mode",
      "title": "Adventure Mode",
      "icon": "sword",
      "summary": "Character creation, combat, survival, quests, exploration and companions."
    },
    {
      "id": "mods",
      "title": "Mods & DFHack",
      "icon": "gear",
      "summary": "Best mods, Steam Workshop, graphics packs, DFHack installation and commands."
    },
    {
      "id": "guides",
      "title": "Guides",
    ...
    },
    {
      ...
      "title": "Blueprints",
      "icon": "grid",
      "summary": "Fortress layouts, industry layouts, defense patterns and megaproject inspiration."
    },
    {
      "id": "updates",
      "title": "Updates",
      "icon": "horn",
      "summary": "Steam update summaries, patch notes, dev diary summaries and roadmap watchpoints."
    }
  ],
  "tips": [
